...
namespace OpenXLSX
{
    ...
    public:
        ...
        explicit XLStringArena(size_t blockSize = 4 * 1024 * 1024) : m_blockSize(blockSize), m_currentOffset(blockSize) {}
        ...
        void clear() noexcept
        {
            for (auto& blk : m_activeBlocks) m_freeBlocks.push_back(std::move(blk));
    ...
    private:
        ...
        [[nodiscard]] size_t blockCapacity() const noexcept { return m_activeBlocks.empty() ? 0 : m_activeBlocks.back().capacity; }
