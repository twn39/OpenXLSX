...
namespace { 
inline const std::string& __global_unique_testXLCellValueProxy_0() {
...
TEST_CASE("XLCellValueProxyTests", "[XLCellValue]")
{
    ...
    {
        XLDocument doc;
        doc.create(__global_unique_testXLCellValueProxy_0(), XLForceOverwrite);
    ...
    SECTION("XLCellValueProxy copy assignment")
    {
        ...
        REQUIRE(std::string(wks.cell("A2").value().typeAsString()) == "string");
        ...
        REQUIRE(std::string(wks.cell("A2").value().typeAsString()) == "float");
        ...
        REQUIRE(std::string(wks.cell("A2").value().typeAsString()) == "integer");
        REQUIRE_THROWS(wks.cell("A2").value().get<std::string>());
        ...
        REQUIRE(std::string(wks.cell("A2").value().typeAsString()) == "boolean");
        REQUIRE_THROWS(wks.cell("A2").value().get<std::string>());
        REQUIRE_THROWS(wks.cell("A2").value().get<int>());
        ...
        REQUIRE(std::string(wks.cell("A2").value().typeAsString()) == "error");
        ...
        REQUIRE(std::string(wks.cell("A2").value().typeAsString()) == "empty");
